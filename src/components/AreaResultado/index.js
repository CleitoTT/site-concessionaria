...
export default function AreaResultado(){
    return(
        <div className="w-5/6 h-4/5 mt-16 border-4 boder-solid rounded-3xl border-[#E10029] bg-transparent flex flex-col justify-evenly items-center lg:w-2/6 lg:mt-0 lg:ml-16 lg:mr-5" >
